module.exports = [
    "sikiş", "hammına", "hammınake", "dalyarak", "püamk", "puamk", "benseninamk",
    "porno", "sex", "fuck", "bitch", "*q", "idiot", "yarra",
    "@m", "@mcı", "@mcık", "dev@mlı", "mmli", "y@rr", "y@rr@", "y@rra", "y@rr@k", "d@ly@rr@k",
    "vayaq", "ohaamk", "ohaaq", "a*", "amkk", "s*kerim", "sikerim",
    "aw", "puşt", "a*k", "mq", "aq", "amk", "sikerim", "sik",
    "orospu", "sikik", "ibne", "piç", "sokuk", "gavat", "pezevenk",
    "pzvng", "pezeveng", "yarrak", "yarram", "am", "amına", "amına ke",
    "amına koyim", "amına koyayım", "salak", "mal", "kahpe", "gerizekalı",
    "kürtaj", "anal", "eşek", "götler", "bitching", "oral seks", "bollok",
    "taşaklar", "bellend", "orospular", "memeler", "buceta", "popo", "cipa", "cunillingus", "am",
    "klitoris", "saksocu", "bok", "boşalmak", "cumshot", "s!kik", "s!k!k",
    "çük", "yapay penis", "dildolar", "dink", "duche", "lezbiyen",
    ...
    "titt", "vajina", "viagra", "vulva", "wang", "@mk", "@q", "orosbu",
    "4r5e", "5h1t", "5hit", "a55", "anal", "ar5e", "arrse", "arse", "fahişe",
    ...
    "butthole", "buttmuch", "buttplug", "c0ck", "c0cksucker", "carpet muncher",
    ...
    "fistfucker", "fistfuckers", "fistfucking", "fistfuckings", "fistfucks", "flange", "fook",
    "fooker", "fuck", "fucka", "fucked", "fucker", "fuckers", "fuckhead", "fuckheads", "fuckin",
    "fucking", "fuckings", "fuckingshitmotherfucker", "fuckme", "fucks", "fuckwhit", "fuckwit",
    "fudge packer", "fudgepacker", "fuk", "fuker", "fukker", "fukkin", "fuks", "fukwhit", "fukwit",
    "fux", "fux0r", "f_u_c_k", "gangbang", "gangbanged", "gangbangs", "gaylord", "gaysex", "goatse",
    ...
    "ma5terb8", "ma5terbate", "masochist", "master-bate", "masterb8", "masterbat*", "masterbat3", "masterbate",
    ...
    "muff", "mutha", "muthafecker", "muthafuckker", "muther", "mutherfucker", "n1gga", "n1gger",
    "nazi", "nigg3r", "nigg4h", "nigga", "niggah", "niggas", "niggaz", "nigger", "niggers", "nob",
